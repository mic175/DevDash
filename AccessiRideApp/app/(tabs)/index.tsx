...
const AccessibilityMap = ({ markers, mapRef, styles }: { markers: Coordinate[], mapRef: React.RefObject<MapView>, styles: any }) => (
...
                    <Text style={styles.directionText}>{step.html_instructions.replace(/<[^>]*>?/gm, '')}</Text>
                </View>
            )
        })}
    </View>
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.header}>
                    <View style={styles.headerBrand}>
                        <CarFront color={BRAND.navy} width={24} height={24} />
                    ...
                    >
                        {darkMode ? <Sun size={18} color={BRAND.navy} /> : <Moon size={18} color={BRAND.navy} />}
                        <Text style={styles.darkModeButtonText}>{darkMode ? "Light" : "Dark"}</Text>
                    </TouchableOpacity>
                </View>
                
                <TouchableOpacity onPress={onBack} style={styles.backButton}>
                    <ArrowLeft size={20} color={BRAND.teal} />
                ...
                <View style={styles.section}>
                    <View style={styles.featureGrid}>
                        <FeatureCard icon={<Accessibility color={BRAND.teal} size={32} />} title="Wheelchair-Ready" desc="Vehicles equipped with ramps or lifts." />
                        <FeatureCard icon={<Hospital color={BRAND.teal} size={32} />} title="Clinic-Focused" desc="Optimized for hospital & therapy visits." />
                        <FeatureCard icon={<Accessibility color={BRAND.teal} size={32} />} title="Driver Assist" desc="Drivers trained for mobility support." />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={{ alignItems: 'center', marginTop: 24 }}>
                        ...
                        <TouchableOpacity style={styles.phoneLink} onPress={() => Linking.openURL('tel:180094335743')}>
                            <Phone size={18} color={BRAND.teal} />
...
const getAccessibilityStyles = (darkMode: boolean) => {
    ...
    return StyleSheet.create({
        ...
        container: {
            flex: 1,
            backgroundColor: darkMode ? '#121826' : BRAND.white,
        },
        header: {
            ...
            backgroundColor: BRAND.white, // Header is always white as per design
        },
        headerBrand: { flexDirection: 'row', alignItems: 'center', gap: 8 },
        headerBrandText: { color: BRAND.navy, fontSize: 18, fontWeight: 'bold' },
        darkModeButton: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: BRAND.navy, borderRadius: 6 },
        darkModeButtonText: { color: BRAND.navy },
        backButton: { margin: 16, flexDirection: 'row', alignItems: 'center', gap: 8 },
        backButtonText: { color: BRAND.teal, fontWeight: '600', fontSize: 16 },
        heroSection: { backgroundColor: BRAND.lightTeal, paddingHorizontal: 16, paddingVertical: 48, alignItems: 'center' },
        heroTitle: { fontSize: 32, fontWeight: 'bold', color: BRAND.navy, textAlign: 'center' },
        heroSubtitle: { marginTop: 16, fontSize: 18, color: BRAND.textDark, textAlign: 'center' },
        section: { paddingVertical: 24, paddingHorizontal: 16 },
        sectionTitle: { fontSize: 22, fontWeight: '600', color: BRAND.navy, textAlign: 'center' },
        featureGrid: { marginTop: 24, gap: 16 },
        featureCard: { backgroundColor: BRAND.cardBg, padding: 24, borderRadius: 8, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, },
        featureCardTitle: { fontWeight: '600', fontSize: 18, marginBottom: 8, color: BRAND.textDark },
        featureCardDesc: { fontSize: 14, opacity: 0.9, color: BRAND.textLight, textAlign: 'center' },
        statementSection: { backgroundColor: BRAND.lightGray, paddingVertical: 48, paddingHorizontal: 16, alignItems: 'center' },
        listItem: { fontSize: 18, marginVertical: 4, color: BRAND.textDark },
        formContainer: { marginTop: 24, backgroundColor: BRAND.cardBg, padding: 24, borderRadius: 8, gap: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
        textInput: { height: 48, borderRadius: 6, borderWidth: 1, borderColor: '#D1D5DB', paddingHorizontal: 12, backgroundColor: BRAND.inputBg, fontSize: 16, color: BRAND.textDark, },
        submitButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, backgroundColor: BRAND.teal, borderRadius: 6 },
        submitButtonText: { color: BRAND.white, fontWeight: 'bold', fontSize: 16 },
        bodyText: { color: BRAND.textDark },
        phoneLink: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 },
        phoneLinkText: { color: BRAND.teal, fontWeight: 'bold', fontSize: 18 },
        emergencyButton: { position: 'absolute', bottom: 24, right: 16, paddingHorizontal: 20, paddingVertical: 14, borderRadius: 999, backgroundColor: BRAND.yellow, flexDirection: 'row', alignItems: 'center', gap: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 4, }, shadowOpacity: 0.3, shadowRadius: 5, elevation: 8, },
        emergencyButtonText: { color: '#000', fontWeight: 'bold' },
        footer: { marginTop: 32, paddingVertical: 24, backgroundColor: BRAND.navy, alignItems: 'center' },
        footerText: { color: BRAND.white, fontSize: 12 }
    });
};